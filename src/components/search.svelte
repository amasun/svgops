...
<div class="relative">
  ...
  {#if !searchValue}
    <button
      ...
      class="absolute top-1/2 right-2 hidden -translate-y-1/2 cursor-pointer items-center space-x-1.5 rounded-md p-1 text-sm text-neutral-400 transition-colors hover:text-neutral-600 sm:flex dark:text-neutral-400 dark:hover:text-neutral-300"
      title="Focus search (Cmd + K)"
