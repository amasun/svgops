<script lang="ts">
  ...
  const aiPrompt = $derived(
    `The following is a documentation page from svgops, a web app for website UI icons: ${documentUrl}. Help me understand how to use it. Be ready to explain concepts, give examples, or help debug based on it.`,
  );
