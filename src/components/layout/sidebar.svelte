<script lang="ts">
  ...
  import SidebarDisclaimer from "@/components/layout/sidebarDisclaimer.svelte";
...
<section>
  ...
  >
    ...
    <nav class="relative min-h-0 flex flex-1 flex-col space-y-0.5 overflow-hidden">
      <ScrollArea
  ...
  <main class={cn("px-2 md:mr-4 md:ml-56 md:px-0", "overflow-x-clip")}>
    <slot />
  </main>
</section>
