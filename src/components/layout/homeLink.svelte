...
<ContextMenu.Root>
  <ContextMenu.Trigger>
    <InternalLink
      href="/"
      className="flex cursor-pointer items-center space-x-2 transition-colors hover:text-neutral-700 dark:hover:text-neutral-300"
    >
      <Svgl size={28} />
      <h2 class="text-xl font-medium tracking-tight">svgops</h2>
    </InternalLink>
  </ContextMenu.Trigger>
